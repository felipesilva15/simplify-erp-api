...
class StorePartnerRequest extends FormRequest
{
    ...
    {
        return [
            'partner_type_code' => 'required|string|min:1|max:20|exists:partner_types,code',
            ...
            'document_number' => 'required|string|min:1|max:20|unique:partners,document_number',
            ...
            'state_registration' => 'nullable|required_if:taxpayer_type,'.TaxpayerTypeEnum::Taxpayer->value.'|prohibited_if:person_type,'.PersonTypeEnum::Person->value.'|string|min:1|max:14',
            'municipal_registration' => 'nullable|prohibited_if:person_type,'.PersonTypeEnum::Person->value.'|string|min:1|max:15',
            'suframa_registration' => 'nullable|prohibited_if:person_type,'.PersonTypeEnum::Person->value.'|string|min:1|max:9',
            'marital_status' => ['nullable', 'prohibited_if:person_type,'.PersonTypeEnum::Company->value, Rule::enum(MaritalStatusEnum::class)],
            'cbo' => 'nullable|string|min:1|max:6',
            'gender' => ['nullable', 'prohibited_if:person_type,'.PersonTypeEnum::Company->value, 'required_if:person_type,'.PersonTypeEnum::Person->value, Rule::enum(GenderEnum::class)],
            'birth_date' => 'nullable|date',
            'father_name' => 'nullable|prohibited_if:person_type,'.PersonTypeEnum::Company->value.'|string|min:1|max:120',
            'father_document' => 'nullable|prohibited_if:person_type,'.PersonTypeEnum::Company->value.'|string|min:1|max:15',
            'mother_name' => 'nullable|prohibited_if:person_type,'.PersonTypeEnum::Company->value.'|string|min:1|max:120',
