...
/**
 * @OA\Schema(
 *     schema="PartnerTypeLookupCollection",
 *     type="object",
 *     allOf={
 *         @OA\Schema(
 ...
 * )
 */
class PartnerTypeLookupCollection extends ResourceCollection
{
    public function toArray(Request $request): array
    {
        ...
        return [
            'data' => PartnerTypeLookupResource::collection($this->collection),
            ...$info
        ];
    }
}
