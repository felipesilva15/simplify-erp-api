 ...
 *      @OA\Property(property="identity_number", type="string", example="Sample", maxLength=15, nullable=true),
 *      @OA\Property(property="identity_issuer", type="string", example="Sample", maxLength=20, nullable=true),
 *      @OA\Property(property="partner_since", type="string", format="date", example="2026-09-09", nullable=true),
 *      @OA\Property(property="state_registration", type="string", example="Sample", maxLength=14, nullable=true),
 *      @OA\Property(property="municipal_registration", type="string", example="Sample", maxLength=15, nullable=true),
 *      @OA\Property(property="suframa_registration", type="string", example="Sample", maxLength=9, nullable=true),
 *      @OA\Property(property="marital_status", type="string", example="Sample", maxLength=30, nullable=true),
 *      @OA\Property(property="cbo", type="string", example="Sample", maxLength=6, nullable=true),
 *      @OA\Property(property="gender", type="string", example="Sample", maxLength=12, nullable=true),
 *      @OA\Property(property="birth_date", type="string", format="date", example="2026-09-09", nullable=true),
 *      @OA\Property(property="father_name", type="string", example="Sample", maxLength=120, nullable=true),
 *      @OA\Property(property="father_document", type="string", example="Sample", maxLength=15, nullable=true),
 *      @OA\Property(property="mother_name", type="string", example="Sample", maxLength=120, nullable=true),
 *      @OA\Property(property="mother_document", type="string", example="Sample", maxLength=15, nullable=true),
