...
use App\Core\Http\Resources\Module\ModulePermitionResource;
 ...
 *      @OA\Property(property="permitions", type="array", @OA\Items(ref="#/components/schemas/ModulePermitionResource")),
...
class ModuleResource extends JsonResource
{
    public function toArray(Request $request): array {
        return [
            ...
            'permitions' => ModulePermitionResource::collection($this->permitions),
